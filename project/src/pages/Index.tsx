...
const ChatPopup = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed bottom-24 right-6 w-96 z-50 animate-fadeIn">
      <Card className="shadow-xl border-2 border-violet-500">
        <CardContent className="p-4">
          ...
          <div className="h-[400px] overflow-y-auto mb-4 p-3 bg-gray-50 dark:bg-gray-800 rounded">
          ...
          <div className="flex gap-2">
            ...
            />
            <Button
              className="bg-gradient-to-r from-violet-500 to-purple-500 hover:from-violet-600 hover:to-purple-600 shadow-lg hover:shadow-violet-500/50"
